...
public class CuratorMaster implements Closeable, LeaderSelectorListener {
     ...
     *
     * @param path path of the assignment
     */
    ...
    public static void main(String[] args) {
        try {
            String myId = "myId-001";
            String hostport = "127.0.0.1:2181";
            CuratorMaster master = new CuratorMaster(myId, hostport, new ExponentialBackoffRetry(1000, 5));
            master.startZK();
            master.bootstrap();
            master.runForMaster();
        } catch (Exception e) {
